...
<div class="w-1/4 h-full flex flex-col gap-2 p-2 bg-white rounded-lg hover:show-lg">
    ...
    <div class="w-full flex justify-center  rounded-lg duration-700 {{ Route::is($link['url']) ? 'font-bold bg-secondary' : 'hover:text-primary hover:font-bold hover:bg-secondary'}} ">
