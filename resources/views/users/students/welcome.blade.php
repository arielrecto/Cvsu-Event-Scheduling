        ...
        <div class="w-4/6 h-auto rounded-lg bg-gray-50 flex flex-col gap-2">
            ...
            <div class="p-5 flex flex-col gap-2">
                <div class="flex flex-col gap-2 items-center">
                        ...
                        <img src="{{asset('student.png')}}" alt="" srcset="" class="h-auto w-1/2">

                        <h1 class="text-5xl font-bold text-accent" > Welcome Student</h1>
                        <p>This page use for the student attempt to login the account in the admin side</p>
