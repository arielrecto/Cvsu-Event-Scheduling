                ...
                <div class="flex items-center justify-between">
                    <div class="input-generic-div w-full">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button @click="addSpeakerField = index" class="btn btn-xs btn-accent">Add Fields</button>
                        </div>
                            ...
                            <div class="w-fill flex flex-col gap-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button class="btn btn-xs btn-error" @click="removeField(s_field.localId, index)">
                                            <i class="fi fi-rr-trash"></i>
                                        </button>
                                    </div>
                                </div>
