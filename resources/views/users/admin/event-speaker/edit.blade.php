<x-dashboard.base>
    <div class="panel">
        <h1 class="panel-title">Event Speaker Edit</h1>
        ...
        <form action="{{ route('speaker.update', ['speaker' => $speaker->id]) }}" method="POST"
            ...
            <div class="grid grid-cols-3 grid-flow-row gap-5">
                ...
                <div class="input-generic-div">
                    ...
                    <input type="text" name="first_name" class="input-generic"
                        placeholder="{{ $speaker->first_name }}">
                ...
                <div class="input-generic-div">
                    ...
                    <input type="text" name="middle_name" class="input-generic"
                        placeholder="{{ $speaker->middle_name }}">
                </div>
            </div>
            <div class="grid grid-cols-2 grid-flow-row gap-5">
                <div class="input-generic-div">
                    <label for="" class="input-generic-label">Age <span>*</span></label>
                    <input type="number" class="input-generic" name="age" placeholder="{{ $speaker->age }}">
                    @if ($errors->has('age'))
                        <p class="text-xs text-error">{{ $errors->first('age') }}</p>
                    @endif
                </div>
                <div class="input-generic-div">
                    <label for="" class="input-generic-label">Gender: {{ $speaker->gender }}</label>
            ...
            <div class="input-generic-div">
                ...
                <input type="text" name="address" class="input-generic" placeholder="{{ $speaker->address }}">
