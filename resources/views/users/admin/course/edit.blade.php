<x-dashboard.base>
    ...
    <div class="flex flex-col gap-5">
        ...
        <x-dashboard.header :route="route('course.index')" :event_name="'Course Edit'" />
        ...
        <div class="panel">
            ...
            <h1 class="panel-title">Update Course</h1>


            <form action="{{route('course.update', ['course' => $course->id])}}" method="post" class="w-full flex flex-col gap-2">
                @csrf
